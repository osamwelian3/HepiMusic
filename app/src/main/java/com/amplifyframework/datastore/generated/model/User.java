...
public final class User implements Model {
  ...
  public static final QueryField PHONE_NUMBER = field("User", "phone_number");
  ...
  private User(String id, String name, String email, String phone_number) {
    this.id = id;
    this.name = name;
    this.email = email;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String email, String phoneNumber) {
      super.id(id);
      super.name(name)
        .email(email)
