 ...
 * Use the [AdminCreatorsMenuBottomSheetDialogFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class AdminCreatorsMenuBottomSheetDialogFragment : BaseMenuBottomSheet() {
    ...
    lateinit var binding: FragmentAdminCreatorsMenuBottomSheetDialogBinding
    lateinit var viewModel: AdminCreatorsViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = FragmentAdminCreatorsMenuBottomSheetDialogBinding.inflate(LayoutInflater.from(requireContext()))
        ...
        creator = requireArguments().getParcelable("creator")!!
    ...
    override fun onCreateView(
        ...
        /*return inflater.inflate(
            R.layout.fragment_admin_creators_menu_bottom_sheet_dialog,
            container,
            false
        )*/
        return binding.root
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            binding.editCreator.id -> editCreator()
            binding.delete.id -> deleteCreator()
        }
    }

    private fun editCreator() {
        viewModel.getObservable()._editClicked.postValue(true)
        findNavController().popBackStack()
    }

    private fun deleteCreator() {
    ...
    private fun showDeleteConfirmation() {
        fun deletePlaylist(dialog: DialogInterface?) {
            ...
            viewModel.getObservable().data.observe(viewLifecycleOwner, Observer {
                ...
                if (activity != null && !isDetached) {
                    val message = if (it.success) {
                        ...
                        getString(R.string.sth_deleted, creator!!.originalCreator.name)
                    } else {
            ...
            viewModel.getObservable().deleteCreator()
        ...
        val builder = AlertDialog.Builder(requireActivity())
            .setMessage(requireActivity().getString(R.string.song_delete_message, creator!!.originalCreator.name))
    ...
    companion object {
         ...
         * @return A new instance of fragment AdminCreatorsMenuBottomSheetDialogFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AdminCreatorsMenuBottomSheetDialogFragment().apply {
